 ...
 * sectionToFileMaps.grovy file. This class is the DTO for the 'notIn' closure. 
 * 
 * @author John Deardurff
 *
 */
@XmlRootElement(name = "notIn")
@XmlAccessorType(XmlAccessType.FIELD)
public class NotInNode extends Criteria {
	
	public NotInNode() {super();}
	
	public NotInNode(String diseaseList) {
		super(diseaseList);
	}
	...
	public boolean test(String diseaseCode) {
		...
		// So, if the specified study is NOT IN the list of studies that exist in the config file for this 
	...
	public String toString() {
		...
		try {
			...
			marshaller = JAXBContext.newInstance(NotInNode.class).createMarshaller();
